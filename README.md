...
This repository implements the complete DevOps case study in independent,
reviewable sections:
...
- [`docs/devops-case-study-architecture.jpg`](docs/devops-case-study-architecture.jpg)
  is a rendered preview of the architecture.
